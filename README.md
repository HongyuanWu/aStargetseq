### Project Update
* 10/25/2019, beagle imputation and phasing then apply 2LOF analysis to AS-Target-Seq dataset ([imputation result](/home/local/MFLDCLIN/guosa/hpc/project/IL23IL17/Shicheng/2LOF/MIS)). 
