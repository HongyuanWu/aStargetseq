### Project Update
* 
* 10/29/2019,generate new lof vcf from imputated dataset ``
* 10/28/2019, new LoF list were created and saved in `~/hpc/db/Gnomad/exome/aloft-exome-rec/annovar` check my script [here](https://raw.githubusercontent.com/Shicheng-Guo/HowtoBook/master/ANNOVAR/annovar2lof.R)
